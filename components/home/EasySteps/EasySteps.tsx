  ...
  const steps: Step[] = [
    {
      ...
      description: "Spend just a few hours capturing your raw videos with ease.",
    ...
    <section className="relative py-16 lg:py-24 px-6 lg:px-8 bg-[#EBF3FF]">
      <div className="max-w-8xl mx-auto">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-4xl lg:text-6xl font-semibold text-[#121116] leading-tight mb-6">
            Get Your Video
            <br />
            Done in 6 Easy Steps
          </h2>
          <p className="text-base lg:text-xl text-[#404040] mb-8 max-w-3xl mx-auto">
